  ...
  return <html lang="en"><body>
    <header className="topbar"><div className="shell topbar-inner">
      ...
      <nav className="nav" aria-label="Primary">
        <Link href="/discover">Discover</Link><Link href="/search">Search</Link><Link href="/collections">Collections</Link><Link href="/settings">You</Link><Link href="/auth">Sign in</Link>
      </nav>
    </div></header>
    {children}
  </body></html>;
