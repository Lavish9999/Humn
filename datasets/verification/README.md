...
| Real images photographed from a screen or print | 100 | negative-control recaptures to measure whether recapture escalation is over-broad |
...
- `report.md`: readable precision, recall, false-positive rate, false-verification rate, escalation rate and coverage
...
- **Escalation rate:** cases deliberately left undecided / all samples.
